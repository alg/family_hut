...
class AlbumsHelperTest < ActionView::TestCase
  ...
  should "return the tag for the previous photo" do
    ...
    assert_equal "<div class=\"prev\"><a href=\"/albums/#{@album.id}/photos/#{@photo2.id}\">&lt;&lt;</a></div>", link_to_previous_photo(@photo1)
  end
  
  should "return the tag for the next photo" do
    # Everything is reversed -- latest first
    assert_nil link_to_next_photo(@photo1)
    assert_equal "<div class=\"next\"><a href=\"/albums/#{@album.id}/photos/#{@photo1.id}\">&gt;&gt;</a></div>", link_to_next_photo(@photo2)
  end
